...
Untuk menemukan struktur yang lebih siap produksi, intip [folktale](http://folktale.origamitower.com/) atau [fantasy-land](https://github.com/fantasyland).

Perhatikan bahwa beberapa metode juga merujuk ke fungsi yang didefinisikan dalam [Lampiran A](./appendix_a-id.md).
